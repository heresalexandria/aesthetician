...
| | |
|---|---|
| **196 presets** | 13 families: film (31), audio-only (29), vhs (23), broadcast (21), digital (20), world cinema (20), cartoon (17), decay (8), exhibition (6), print (6), stylized (6), transmission (5), adjust (4) |
| **254 variants** | alternate states of each look: worn prints, fifth-generation dubs, storm reception, terminal decay |
| **104 effects, 509 parameters** | every one exposed and documented, in the app and from the CLI |
...
- [docs/catalog.md](docs/catalog.md) - all 196 presets and every knob
