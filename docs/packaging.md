...
# expect: 103 effects 191 presets
...
- The app icon (`app/build/icon.png`) is generated by
  `scripts/package/make_icon.py`; regenerate it there rather than editing the PNG.
